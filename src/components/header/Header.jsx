...
const Header = ({ isMain }) => {
    const headerClas = isMain ? "header" : " header header__green";
    ...
    return (
        <div className={headerClas}>
            ...
            <nav className="header__nav">
                ...
                <Link to={routes.COOPERATION} className="header__nav-btn btn-animation">
                    Співпараця
                </Link>
                <Link to={routes.NEWS} className="header__nav-btn btn-animation">
                    Новини
                </Link>
                <Link to={routes.CONTACTS} className="header__nav-btn btn-animation">
                    Контакти
                </Link>
                <div className={buyBtnClass}>Купуй онлайн</div>
                <div className="header__nav-divider"></div>
                <Link to={routes.VACANCY} className={vacClass}>
                    Вакансії
                </Link>
            </nav>
        </div>
